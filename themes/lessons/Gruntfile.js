// Generated on 2013-10-29 using generator-pugpig 2.0.5
'use strict';
...
module.exports = function (grunt) {
  ...
  var cms = 'YOUR_CMS',
    ...
    yeomanConfig = {
      app: 'app',
      dist: {
        'static': distRoot + '/pugpig-lessons-static',
        'theme': distRoot + '/pugpig-lessons-theme'
      }
    };
  ...
  grunt.initConfig({
    ...
    replace: {
      drupal: {
        src: ['<%= yeoman.dist.theme %>/lessons.info'],
        overwrite: true,
        replacements: [{
          from: /version\s*=\s*".*?"/g,
